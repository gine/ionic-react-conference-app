...
import { calendar, contract, hammer, help, informationCircle, logIn, logOut, map, person, personAdd } from 'ionicons/icons';
...
const routes = {
  appPages: [
    ...
    { title: 'Speakers', path: '/tabs/speakers', icon: contract },
